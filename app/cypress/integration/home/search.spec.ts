...
const activityKeywordApi =
  'https://ptx.transportdata.tw/MOTC/v2/Tourism/Activity?$filter=contains(ActivityName,+%27%E9%9F%B3%E6%A8%82%E7%A5%AD%27)&$top=10&$format=JSON';
const scenicSpotKeywordApi =
  'https://ptx.transportdata.tw/MOTC/v2/Tourism/ScenicSpot?$filter=contains(ScenicSpotName,+%27%E9%9F%B3%E6%A8%82%E7%A5%AD%27)&$top=10&$format=JSON';
const hotelKeywordApi =
  'https://ptx.transportdata.tw/MOTC/v2/Tourism/Hotel?$filter=contains(HotelName,+%27%E9%9F%B3%E6%A8%82%E7%A5%AD%27)&$orderby=ZipCode&$top=10&$format=JSON';
const restaurantKeywordApi =
  ' https://ptx.transportdata.tw/MOTC/v2/Tourism/Restaurant?$filter=contains(RestaurantName,+%27%E9%9F%B3%E6%A8%82%E7%A5%AD%27)&$top=10&$format=JSON';
...
describe('Search Page', async () => {
  ...
  it('Activity', () => {
    ...
    cy.get('[data-testid=activityCard]')
      .first()
      .should('contain', 'ActivityName1');
    cy.get('[data-testid=activityCard]')
      .eq(1)
      .should('contain', 'ActivityName2');
  });
